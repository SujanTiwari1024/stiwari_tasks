...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Sujan Tiwari</a>
  ...
  <div class="row" style="margin-top: 10px; margin-bottom: 10px; margin-right: 5px;">
    <div class="col-sm-3" style="background-color: rgba(228, 235, 194, 0.353);">
      <h2>PHP Excercise</h2>
          You will find detailed in-class excercise solutions here. <br>
          You can navigate through excercise with privided link.
    </div>
    <div class="col-sm-9">